...
It its therefore advised to isolate the leukocytes before proceeding with DNA isolation or RNA isolotion (if desired) for better results.  Many protocols already incorporate this step, but for some circumstances it may be useful to process the entire blood sample this way before proceeding.  
...
DNA isolation is normally followed by some type of [genotyping](#molecular_genotyping) experiment.
