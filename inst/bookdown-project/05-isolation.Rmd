...
Isolating various tissues is very important in a genetics lab.  There are many different techniques that
...
## Leukocyte (Buffy Coat) Isolation
...
knitr::include_graphics("images/blood_separation.png") 
```

Therefore, it is advised to isolate the leukocytes before proceeding with DNA isolation for better results. Many protocols already incorporate this step, but for some circumstances, it may be useful to process the entire blood sample this way before proceeding.

## DNA Isolation {#isolating_dna}
