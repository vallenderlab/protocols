...
### Restriction Fragment Length Polymorphism Analysis (Optional) {#restriction_enzyme}
...
Check the [appendix](#troubleshooting_pcr) for more info on troubleshooting thermocycler programs and PCRs in general.
